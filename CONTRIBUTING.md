...
Fork the project [on GitHub](https://github.com/geut/network-setup) and check out your copy locally.

```bash
$ git clone git@github.com:username/network-setup.git
$ cd network-setup
$ npm install
$ git remote add upstream git://github.com/geut/network-setup.git
```
